function ShadowButton({ bg, type, textColor, text, width, onClick }) {
  return (
    <button
      onClick={onClick}
      type={type}
    ...
    >
      <div
        className={`text-center justify-start ${textColor ? textColor : `text-white`} text-base font-bold leading-normal`}
      >
        {text}
      </div>
    </button>
