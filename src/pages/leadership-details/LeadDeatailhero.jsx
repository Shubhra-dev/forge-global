    ...
    >
        ...
        <div className="w-full sm:w-[60%] tab:w-[55%]">
          ...
          <div className="py-8">
            ...
            >
              ...
              vision toward a world where everyone can love their life and work.
              Our commitment to Slalom’s vision-led, purpose-driven,
              values-based culture has earned us a consistent reputation as one
      ...
      <div className="tab:w-[60%] m-auto">
        <SmallHeading fontWeight={`font-normal`} align={`text-justify`}>
          John is the Worldwide Managing Partner, CEO, and Chairman of the Board
          of Directors at Finovate, where he oversees global strategy and
          operations while preserving Bain’s renowned culture. With over 20
          years at the firm, John has advised global CEOs and is a recognized
          expert in deal advisory and value creation for portfolio companies. He
          has a strong background in private equity, corporate mergers and
          acquisitions, and consumer products. John is also involved in
          sustainability initiatives and serves on the Board of Directors of
          Cancer, a non-profit focused on fighting pediatric cancer. He holds
          master’s degrees in civil engineering and multilingual business
          communication from the University of Ghent and is based in New York.
        </SmallHeading>
      </div>
    </SectionLayout>
  );
...
export default LeadDeatailhero;
