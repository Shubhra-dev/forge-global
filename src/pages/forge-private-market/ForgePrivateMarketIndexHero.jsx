...
import PriMarIndHeroBg from "../../assets/PriMarIndHeroBg.jpg";
import Title from "../../components/Title";
import BigText from "../../components/BigText";

function ForgePrivateMarketIndexHero() {
  return (
    <div
      className="pt-[100px] sm:pt-[65px] pb-16 sm:pb-0 h-auto relative sm:h-[600px] w-full bg-backgroundPrimary dark:bg-backgroundDarkGeneral bg-center bg-no-repeat flex items-center"
      style={{ backgroundImage: `url(${PriMarIndHeroBg})` }}
    >
      <div className="m-auto max-w-content w-full">
        <div className="px-4 smLap:px-0 smLap:w-10/12 laptop:w-9/12 m-auto my-auto flex flex-col tab:flex-row items-center justify-between gap-10">
          <div className="w-full tab:w-[65%]">
            ...
            >
              Benchmark for actively traded private companies
            </BigText>
            <SmallHeading
              align={`text-center sm:text-left`}
              textColor={`text-textSubTitleDark`}
...
export default ForgePrivateMarketIndexHero;
