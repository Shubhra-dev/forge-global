...
function CompanyDetails() {
  return (
    <>
      ...
      <CompanyStockPrice />
      <FundingRounds />
      <SectionLayout id={`compnay-details`}>
        <div className="w-full flex-col tab:flex-row items-start justify-between flex gap-10 tab:gap-16">
          <div className="w-full tab:w-1/2">
            ...
            <Text extraClass={`pt-[15px]`}>
              ...
              strives to build AI that enhances productivity and supports
              various industries. This company was founded by Elon Musk in 2023
