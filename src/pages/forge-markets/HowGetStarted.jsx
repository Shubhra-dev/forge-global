...
import HowGetStartedImg from "../../assets/HowGetStarted.png";
        ...
        <div className="w-full sm:w-1/2">
          ...
          <div className="pt-10">
            ...
            <Text extraClass={`pb-5`}>
              ...
              investors and shareholders alike. In a market where timing can be
              important, Forge is an avenue to potentially achieve
        ...
        <div className="w-full sm:w-1/2">
          ...
          <div className="pt-10">
            ...
            <Text extraClass={`pb-5`}>
              ...
              Create a free account to connect with a Private Market Specialist
